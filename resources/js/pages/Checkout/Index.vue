    ...
    <div class="min-h-screen overflow-x-clip bg-[#fffaf0] text-[#17152b]">
        <header class="border-b-2 border-[#17152b] bg-[#fffaf0]">
            ...
            >
                ...
                <Link
                    href="/"
                    class="inline-flex min-h-11 items-center gap-2 text-sm font-black hover:text-[#9a5b00] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#9a5b00]"
        ...
        <main>
            <section class="border-b-2 border-[#17152b] bg-[#f6c945]">
                <div
                    class="mx-auto grid max-w-7xl gap-8 px-5 py-10 lg:grid-cols-[1fr_auto] lg:items-end lg:px-8 lg:py-14"
                >
                    <div>
                        <p
                            class="flex items-center gap-3 text-sm font-black text-[#9a5b00]"
                        >
            ...
            >
                <section aria-labelledby="package-heading">
                    <div class="flex items-end justify-between gap-4">
                        ...
                        <KeyRound class="size-7 text-[#9a5b00]" />
                    </div>
                    ...
                    >
                        <button
                            ...
                            class="relative min-h-60 p-6 text-left transition focus-visible:z-10 focus-visible:outline-3 focus-visible:outline-offset-[-6px] focus-visible:outline-[#9a5b00] sm:p-7"
                            :class="[
                                index === 0
                    ...
                    <div class="mt-8 border-y-2 border-[#17152b] py-7">
                        <div class="flex items-start justify-between gap-5">
                            <div>
                                <p class="text-xs font-black text-[#9a5b00]">
                                    PILIHAN ANDA
                                </p>
                        ...
                        >
                            <li class="flex gap-3">
                                <Users class="size-5 shrink-0 text-[#9a5b00]" />
                                {{
                    ...
                    <div class="mt-8 grid gap-5 sm:grid-cols-3">
                        ...
                        <div class="border-l-4 border-[#f6c945] pl-4">
                ...
                <aside class="relative lg:sticky lg:top-6">
                    <div
                        class="absolute -right-3 -bottom-3 h-full w-full rounded-[28px_28px_28px_7px] border-2 border-[#17152b] bg-[#f6c945]"
                    ></div>
                    <section
                        ...
                        <form class="mt-7 grid gap-5" @submit.prevent="pay">
                            <label class="grid gap-2 text-sm font-black">
                                ...
                                <input
                                    ...
                                    required
                                    autocomplete="name"
                                    class="min-h-13 w-full rounded-[14px_14px_14px_4px] border-2 border-[#17152b] bg-[#fffaf0] px-4 font-semibold placeholder:font-normal placeholder:text-[#777487] focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-[#9a5b00]"
                            ...
                            <button
                                ...
                                class="inline-flex min-h-14 w-full items-center justify-center gap-3 rounded-[18px_18px_18px_5px] border-2 border-[#17152b] bg-[#f6c945] px-5 font-black text-[#17152b] transition hover:-translate-y-0.5 hover:bg-[#ffd95f] focus-visible:outline-3 focus-visible:outline-offset-4 focus-visible:outline-[#ff766b] disabled:cursor-wait disabled:opacity-60"
                                type="submit"
                            >
                                <CreditCard class="size-5" />
                                {{
